...
const DashboardHeader = ({ status, handleStart, handleStop, isDisabled, handleSubmit, handleRevert }) => {
          ...
          {location.pathname === "/settings" ? (
            ...
            <>
              ...
              <button className={styles.stopButton} onClick={handleStop} disabled={!isDisabled}>
                <FaStop className={styles.iconOnly} /> <span className={styles.buttonText}>Stop</span>
              </button>
            </>
          ) : null}
        </div>
